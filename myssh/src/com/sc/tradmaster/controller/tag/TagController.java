...
public class TagController extends BaseController{
	...
	public List<TagLib> show(Integer tagTpyeId,String projectId,Integer status){
		return tagService.showTagLib(null,"0000",status,null);
	}
	/**
	 * 复制标准标签到某个项目
	 * @param projectId
	 ...
	 */
	@ResponseBody
	@RequestMapping("showTagTypeById")
	public TagType showTagTypeById(Integer tagTypeId){
		return tagService.findTagTypeById(tagTypeId);
	}
	/**
	 * 添加标签类目
	 * @param tt
	...
	public String addTagType(TagType tt){
			tagService.addTagType(tt);
			return "redirect: system_tagManage";
	}
	/**
	 * 删除标签类目
	 * @param tagTypeId
	...
	public String alterTagType(TagType tagType){
	...
	@ResponseBody
	@RequestMapping("showTagById")
	public Tag showTagById(Integer tagId){
		return tagService.findTagByTagIdAndProjectId(tagId,"0000");
	}
	/**
	 * 修改标签
	 * @param tagId
	 ...
	 */
	@ResponseBody
	@RequestMapping("get_project_all_standard_tag_info")
	public List<TagLib> getProjectAllStandardTagInfo(){
		
		List<TagLib> tagLibList = tagService.showTagLib(null, "0000", null, null);
