...
public class ContractRecordsController extends BaseController {
	...
	public ModelAndView getDeal(String projectId, String startTime, String endTime)throws ParseException {
		// 获取session中的用户信息
	 ...
	 * 
	 */
	@RequestMapping("/to_goToRealRevokeOneContractRecord")//TODO
	public void toRevokeContractRecord(Integer recordNo, String killTheOrderReason, String revokeOrderNotes) {
		User user = (User) this.request.getSession().getAttribute("userInfo");
		contractRecordsService.updateContractRecordToRevoke(user,recordNo, killTheOrderReason, revokeOrderNotes);
	 ...
	 * 
	 */
	@RequestMapping("/to_goToSubmitContractRecord")//TODO
	public void toGoToSubmitContracrRecord(Integer orderProperty, Integer isAlreadyRead, Integer payStyle,
			...
			String rengourenIdCard, String realCustomerId, String dposit) throws IOException, ParseException {
		// 获取当前登录用户对象
		User user = (User) this.request.getSession().getAttribute("userInfo");
