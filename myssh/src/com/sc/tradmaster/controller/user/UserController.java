...
public class UserController extends BaseController {
	...
	/** maoxy
	 * 案场经理个人中心---------获取接待顾问信息maoxy
	 * @param num
	 * @return
	 */
	@ResponseBody
	@RequestMapping("/getProjectAgentByNum")
	public List<User> getProjectAgent(Integer num){
		User user = (User) this.request.getSession().getAttribute("userInfo");
		List<User> findProjectAgentByLimit = userService.findProjectAgentByLimit(num, user.getParentId());
		return findProjectAgentByLimit;
	}
