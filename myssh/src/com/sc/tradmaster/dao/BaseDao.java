...
public interface BaseDao {
	...
	public List queryBySql(String newCusVisitSql);

	public List queryBySql(String visitingSql, Class string);
	
	public Object queryObjBySql(String visitingSql, Class string);

	public List queryDTOBySql(String agentOrderSql, Class clazz,String[] colums,String[] types);

	//public int findSumDouble(String totalBuyPriceHql);
