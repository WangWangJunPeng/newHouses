...
public class TagLib implements Serializable{
	...
	private Integer originalTagTypeId;//对应的标准标签Id
	private Integer isRequied;//是否必填
	
	
	
	public Integer getIsRequied() {
		return isRequied;
	}
	public void setIsRequied(Integer isRequied) {
		this.isRequied = isRequied;
	}
	public Integer getOriginalTagTypeId() {
		return originalTagTypeId;
	}
	public void setOriginalTagTypeId(Integer originalTagTypeId) {
		this.originalTagTypeId = originalTagTypeId;
	}
	...
	public String toString() {
		return "TagLib [tagTypeId=" + tagTypeId + ", tagTypeName=" + tagTypeName + ", parentTagTpyeId="
				...
				+ projectId + ", sortNum=" + sortNum + ", tagLibs=" + tagLibs + ", tags=" + tags + ", originalTagType="
				+ originalTagType + ", originalTagTypeId=" + originalTagTypeId + "]";
	}
