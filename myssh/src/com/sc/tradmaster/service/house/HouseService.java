...
public interface HouseService {
	 ...
	 * @return
	 */
	Map addOrUpdateFromClient(House h, String houseTypeName, String preSellNum);
	 ...
	 * @return
	 */
	House findHouseByProperty(String proId, String buildingNo, String unit, Integer floor, String houseNo);

	//房源信息导入
	void addOrUpdateObj(Object obj);
	/**
	 * 添加或删除房源收藏
	 * @param userId
	 * @param houseNum
	 * @param flag 1-添加收藏，2-删除收藏
	 */
	void updateOrAddCollectHouse(String userId, Integer houseNum, int flag);
	/**
	 * 显示收藏列表
	 * @param userId
	 * @return
	 */
	List<SalesHouseDTO> findCollectHouse(String userId);
