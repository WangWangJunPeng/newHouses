...
public class NewOneShopDTO {
	...
	public String toString() {
		return "NewOneShopDTO [shopId=" + shopId + ", shopStatus=" + shopStatus + ", applyTime=" + applyTime
				+ ", approveTime=" + approveTime + ", approveUserId=" + approveUserId + ", shopName=" + shopName
				+ ", companyName=" + companyName + ", address=" + address + ", city=" + city + ", location=" + location
				...
				+ ", inSystemStutas=" + inSystemStutas + ", agentNum=" + agentNum + ", guideRecordsNum="
				+ guideRecordsNum + ", haveDealNum=" + haveDealNum + ", longitude=" + longitude + ", latitude="
				+ latitude + "]";
	}
