...
public interface ContractRecordsService {
	 ...
	 * 中介签约客户
	 */	
	List findMidDeal(User user, String projectId, String startTime, String endTime)throws ParseException;
	 ...
	 * 
	 */
	void updateContractRecordToRevoke(User u,Integer recordNo,String killTheOrderReason,String revokeOrderNotes);
	 ...
	 */
	void addPayByClient(User user, String enterBuyCusPhone, String enterBuyApplyTime,String proId,
