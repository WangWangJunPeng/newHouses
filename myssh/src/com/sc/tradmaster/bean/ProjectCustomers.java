...
public class ProjectCustomers {
	...
	public String getMorePhoneNum() {
		return morePhoneNum;
	}
	public void setMorePhoneNum(String morePhoneNum) {
		this.morePhoneNum = morePhoneNum;
	}
	...
	public String toString() {
		return "ProjectCustomers [projectId=" + projectId + ", projectCustomerId=" + projectCustomerId
				...
				+ description + ", tags=" + tags + ", lastTime=" + lastTime + ", evaluate=" + evaluate + ", job=" + job
				+ "]";
	}
