	   	...
	   	$(document).ready(function(){
		      ...
		      /* initpage1(); */
	   		  ...
	   		  $("#selectButton").click(function(){ 
	   			  $("#selectButton").html('<i class="layui-icon">&#xe63d;</i>');
	   			getShopCustomerManagePageInfo();
...
<body>
	<div class="admin-main">
				...
				<fieldset class="layui-elem-field">
					<legend style="text-align: left;">客户列表</legend>
				...
				<div class="admin-table-page" style="text-align: left;" id="mydiv">
