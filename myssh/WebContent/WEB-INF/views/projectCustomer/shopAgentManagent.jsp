...
<body>
	<div class="admin-main">
			    ...
			    <button class="layui-btn" type="button" id="searchShop" onclick="selectShoperManager()">搜索</button>
			    <a class="layui-btn" href="goto_medi_manage_page">新增经纪人</a>
				</div>
				</form>
				<input id="hidUserId" type="hidden" value="${sessionScope.userInfo.userId}"/>
				</blockquote>
				<fieldset class="layui-elem-field">
					<legend style="text-align: left;">经纪人列表</legend>
