...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="static/css/orderOtherDetails.css" />
...
<body >
	...
	<input id="whichButtonHidSign" type="hidden" value="${whichButtonHidSign}">
    <div class="frame">
            ...
            <div class="wrapper">           
                ...
                <ul class="nav  nav-list">
                    ...
                    <li><a href="to_manager_team_page" class="noDrop"><span>团队</span></a></li>  
                     <li>
                    	<a href="to_manager_team_page" class="noDrop"><span>客户管理</span></a>
                    	<ul style="display:block;border:0;">
        ...
        <div class="content" >
            ...
            <div id="main-content" >
              ...
              <div class="row" style="margin-left:4%;;margin-top:24px;">
                  <div class="col-md-4 listOne oppo" style="width:38%;height:556px;">
                  ...
                  <div class="col-md-7 " style="width:60%;margin-left:1.5%;">
                      <div class="row ">
                          <div class="col-md-7 listOne" style="margin-bottom:20px;padding-bottom:13px;width:60%;">
                              <div class="row" style="margin-top:16px;">
                                  ...
                                  <div class="col-md-3" style="width:28%;margin-top:-2px;">
                                      <span style="font-size:16px;color:#616b88;">客户信息</span>
                                  </div>
                                  <div class="col-md-6" style="text-align:right;width:60%;">
                                    <div class="row">
                                        <div class="col-md-4 " style="width:34%;margin-left:2%;">
                                             <span style="font-size:12px;color:#616b88;">订单性质</span>
                                        </div>
                                        <div class="col-md-4" style="width:30%;margin-top:-2px;">
                                             <input type="radio"  name="buy" id="vOne" style="padding-top:8px;" disabled/>
                                            <label for="vOne" style="vertical-align:top ;font-size:12px;color:#616b88;">自购</label>
                                        </div>
                                        <div class="col-md-4" style="width:30%;margin-top:-2px;">
                                             <input type="radio"  name="buy" id="vTwo" disabled/>
                                            <label  for="vTwo" style="vertical-align:top ;font-size:12px;color:#616b88;">代购</label>
                                        </div>
                                    </div>
                            ...
                            <div class="row" style="margin-top:20px;border-bottom:1px solid #f1f5f7;padding-bottom:14px;">
                                <div class="col-md-1"   style="width:11%;margin-left:2%">
                                    <img src="static/images/buyName.png" class="img-responsive" alt="Responsive image" style="margin-left:5px;margin-top:4px;">
                                </div>
                                <div class="col-md-3" style="width:28%">
                                    <span style="font-size:12px;color:#616b88;">认购姓名</span>
                                </div>
                                <div class="col-md-3 col-md-offset-3" style="text-align:right;padding-right:0px;">
                                    <span style="font-size:12px;color:#616b88;" id="enterBuyName">dddddddd</span>
                                </div>
                            </div>
                              <div class="row" style="margin-top:14px;">
                                <div class="col-md-1" style="width:11%;margin-left:2%">
                                     <img src="static/images/idShen.png" class="img-responsive" alt="Responsive image" style="margin-left:5px;margin-top:4px;">
                                </div>
                                <div class="col-md-3" style="width:28%">
                                    <span style="font-size:12px;color:#616b88;">身份证号码</span>
                                </div>
                                <div class="col-md-3 col-md-offset-3" style="text-align:right;padding-right:0px;">
                                    <span style="font-size:12px;color:#616b88;" id="idCarkNum">444444444454545</span>
                                </div>
                            </div>
                             <div class="row" style="margin-top:28px;">
                                  <div class="col-md-1"  style="width:12%;">
                                      <img src="static/images/dingjin.png" class="img-responsive" alt="Responsive image" style="margin-left:5px;">
                                  ...
                                  <div class="col-md-6 " style="text-align:right;width:60%;">
                                    <div class="row">
                                        <div class="col-md-4 " style="width:34%;margin-left:1%">
                                             <span style="font-size:12px;color:#616b88;">支付方式</span>

                                        </div>
                                        <div class="col-md-4" style="width:32%;margin-top:-2px;">
                            ...
                            <div class="row" style="margin-top:20px;border-bottom:1px solid #f1f5f7;padding-bottom:14px;">
                                <div class="col-md-1" style="width:11%;margin-left:2%">
                                      <img src="static/images/dingShu.png" class="img-responsive" alt="Responsive image" style="margin-left:5px;margin-top:4px;">
                                </div>
                                <div class="col-md-3" style="width:28%">
                                    <span style="font-size:12px;color:#616b88;">订金数额</span>
                                </div>
                                <div class="col-md-3 col-md-offset-3" style="text-align:right;padding-right:0px;">
                                    <span style="font-size:12px;color:#616b88;" id="haveToPay">5454545454</span>
                                </div>
                            </div>
                              <div class="row" style="margin-top:14px;">
                                <div class="col-md-1" style="width:11%;margin-left:2%">
                                     <img src="static/images/yiqian.png" class="img-responsive" alt="Responsive image" style="margin-left:5px;margin-top:4px;">
                                </div>
                                <div class="col-md-3" style="width:28%">
                                    <span style="font-size:12px;color:#616b88;">已签约条款</span>
                                </div>
                                <div class="col-md-3 col-md-offset-3" style="text-align:right;padding-right:0px;">
                          ...
                          <div class="col-md-4  listOne" style="margin-left:1.5%;width:38%;">
                            <div class="row" style="background:#ff6c60;border-radius:6px;line-height:50px;">
                                <div class="col-md-2" style="height:50px;background:#ec6053;border-radius:6px;line-height:50px;">
                                     <img src="static/images/housesXin.png" class="img-responsive" alt="Responsive image" style="margin-left:1.5%;margin-top:14px;">
                                </div>
                                <div class="col-md-8">
                                    <span style="font-size:16px;color:#ffffff;">房源信息</span>
                                </div>
                            </div>
                            <div class="row" style="margin-top:36px;margin-bottom:28px;">
                                <div class="col-md-2 " style="width:20%;margin-left:25%;">
                                    <img id="housePic" src="static/images/cin.png" alt="" style="width:60px;height:60px;"/>
                                </div>
                                <div class="col-md-4" style="width:40%;margin-left:6%;">
                            ...
                            <div class="row" style="background:#f0f4fb;">
                                <div class="col-md-4" style="text-align:center;border-right:1px solid #e5edf9;height:100px">
                      ...
                      <div class="row " style="">
                        ...
                        <div class="col-md-7  listOne " style="width:60%;">
                            ...
                            <div class="row" style="margin-top:18px;border-bottom:1px dashed  #f1f5f7;padding-bottom:14px;">
                                 <div class="col-md-2" >
                            ...
                            <div class="row" style="margin-top:18px;border-bottom:1px dashed  #f1f5f7;padding-bottom:14px;">
                             ...
                             <div class="row" style="margin-top:15px;border-bottom:1px dashed  #f1f5f7;padding-bottom:14px;">
                                 <div class="col-md-2" >
                            ...
                            <div class="row" style="margin-top:18px;border-bottom:1px dashed  #f1f5f7;padding-bottom:12px;">
                                 <div class="col-md-2" >
                        ...
                        <div class="col-md-4  listOne " style="margin-left:2%;width:37%;">
                                <div class="row" style=";border-radius:6px;line-height:50px;">
                                    <div class="col-md-2 " style="height:50px;background:#f3f5fb;border-radius:6px;">
                                         <img src="static/images/pz.png" class="img-responsive" alt="Responsive image" style="margin-left:2.5%;margin-top:14px;">
                                    </div>
                                    <div class="col-md-6">
                                        <span style="font-size:16px;color:#616b88;">付款凭证</span>
                                    </div>                                    
                                </div>
                                <div class="row" style="height:205px;">
                                    <div  class="col-md-12 example"  style="margin-top:30px;text-align:center;" >
                                         <img src=""  style="width:200px;height:120px;" id="payMoneyPic"/>
                                    </div>
                                </div>
                          </div>
                      </div>
              ...
              <div class="row directorCheck" style="margin-top:60px;">
                  <div id="signEnter" class="col-md-4 col-md-offset-2" style="text-align:right;display: none;" >
                      <button  type="button" style="width:130px;height:36px;line-height:34px;font-size:14px;color:#ffffff;border:0;border-radius:4px;background:#46c1de;" onclick="signEnter()">签约确认</button>
                  </div>
                  <div id="waitPayMoneyEnter" class="col-md-4 col-md-offset-3" style="text-align:right;display: none;">
                      <button  type="button" style="width:130px;height:36px;line-height:34px;font-size:14px;color:#ffffff;border:0;border-radius:4px;background:#46c1de;" onclick="payMoneyEnter()">到款确认</button>
                  </div>
              </div>
            </div>
    ...
    <script type="text/javascript" src="static/js/orderOtherDetails.js"></script>
