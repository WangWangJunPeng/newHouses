            ...
            <div id="main-content">
               ...
               <div class="row ">
                    <div class="col-md-12 listOne" style="position: absolute; width:98%;left:1%;top:15%;height: 128%; ">
                      <img src="static/images/dFail.png" alt="" style="position: absolute;top: 30%;left: 48%;width: 70px;height:70px;">
                      <img src="static/images/dPFail.png" alt="" style="position: absolute;top: 40%;left: 55%;">
                      <p style="position: absolute;top: 45%;left: 44%;font-size: 46px;color: #8990a4;">设置失败</p>
                      <button style="position: absolute;top: 58%;left: 47%;border: 0;background: #46c1de;width: 100px;height: 36px;font-size: 14px;color: #fff;border-radius: 5px;" id="reWirte">返回填写</button>
