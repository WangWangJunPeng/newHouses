...
<link rel="stylesheet" type="text/css"
	href="static/css/shopSureBill.css">
...
<body>
			...
			<div class="layui-form-pane"
				...
				<form>
					...
					<div class="layui-input-inline">
						<select name="proId" id="projectSelect" lay-ignore
							style="width: 260px; height: 38px; padding-left: 5px; border: 1px solid #e6e6e6; color: #666;">
							<option value="">全部案场</option>

						</select>
					</div>
					<button class="layui-btn" type="button" id="selectSearch"
						onclick="selectDate()">搜索</button>
				</form>
			</div>
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<span style="margin-left: 20px; color: #0c95db;"
						onclick="tableToExcel1('table')">将输出结果导出Excel</span>
					...
					<div class="admin-table-page" style="position: static;text-align: left;">
						<div id="paged1" class="page"></div>
					</div>
				</div>
				<div class="layui-tab-item">
					<span style="margin-left: 20px; color: #0c95db;"
						onclick="tableToExcel2('table')">将输出结果导出Excel</span>
					<fieldset class="layui-elem-field" style="margin-top: 10px;">
					...
					<div class="admin-table-page" style="position: static;text-align: left;">
						<div id="paged2" class="page"></div>
					</div>
				</div>
				<div class="layui-tab-item">
					<span style="margin-left: 20px; color: #0c95db;"
						onclick="tableToExcel3('table')">将输出结果导出Excel</span>
					<fieldset class="layui-elem-field" style="margin-top: 10px;">
	...
	<div class="sure-pop" style="display: none;">
		...
		<form action="shoper_check_bill_list_enter_or_cancel" method="post">
			<input name="doSingle" value="enterReceive"> <input
				id="sureHidRecordNo" name="recordNo" type="hidden">
			<textarea name="desc" id="reasonOne" cols="30" rows="8"></textarea>
			<div class="btn">
				<input type="submit" value="确定" class="sub-popOne" /> <input
					type="button" value="关闭" class="close-popOne" />
			</div>
		</form>
	</div>
	<div class="cancel-pop" style="display: none;">
		...
		<p>
			请输入取消原因<span class="error-warning"></span>
		</p>
		<form action="shoper_check_bill_list_enter_or_cancel" method="post">
			<input name="doSingle" value="cancelReceive"> <input
				id="cancelHidRecordNo" name="recordNo" type="hidden">
			<textarea name="desc" id="reasonTwo" cols="30" rows="8"></textarea>
			<div class="btn">
				<input type="submit" value="确定" class="sub-popTwo" /> <input
					type="button" value="关闭" class="close-popTwo" />
			</div>
		</form>
	</div>
</body>
