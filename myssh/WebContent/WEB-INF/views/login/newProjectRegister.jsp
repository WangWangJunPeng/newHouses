...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>项目注册</title>
        <link rel="stylesheet" type="text/css" href="static/css/newProjectRegister.css" />
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=dxCgW5uXbilxuIKHY7eYpujkgdsqSj3I"></script>
 ...
 <!--  <link rel="stylesheet" href="http://cache.amap.com/lbs/static/main1119.css"/>
            ...
            <div class="rightArea">
                ...
                <div class="cn" style="display:none;">
                        <div class="every">
                            ...
                            <input type="text" placeholder="请输入公司名称" name="developer" id="developer"/>
                        </div>
                    </div>
                     <div class="cner cner1" style="display:none;">
                        <div class="every">
                            <img src="static/images/housesShop.png" alt="" />
                            <input type="text" placeholder="请输入项目名称" name="projectName" id="projectName"/>
                        </div>
                    </div>
                ...
                <!-- 
                 ...
                 <div class="cner cner2" style="display:none;">
                        <div class="every">
                            ...
                            <input type="text" placeholder="请输入项目地址" name="propertyAddress" id="propertyAddress"/>
                            <input id="propertyLongitude" type="hidden" name="propertyLongitude">
                            <input id="propertyLatitude" type="hidden" name="propertyLatitude">
                        </div>
                    </div>
                     <div class="cner cner3" style="display:none;">
                        <div class="every">
                            <img src="static/images/peopleJJ.png" alt="" />
                            <input type="text" placeholder="联系人" name="userCaption" id="userCaption"/>
                        </div>
                    </div>
    ...
    <script type="text/javascript" src="static/js/newProjectRegister.js"></script>
