	...
	function fillHousesInfo(data) {
		...
		$.each(data,function(v, o) {
							...
							if (o.houseStatus == 0) {
								...
								s += '<td>待付款</td>';
							}else if (o.houseStatus == 6) {
								s += '<td>付款待确认</td>';
							}else if (o.houseStatus == 7) {
								s += '<td>待签约</td>';
							}else if (o.houseStatus == 8) {
								s += '<td>已签约</td>';
							}
							s += '<td><a href="to_update_house_info?hNum='+ o.houseNum+'"><img src="static/images/pen.png"  alt="" /></a>';
							if(o.houseStatus == 0){
								s += '<a href="delete_curren_house_info?hNum='+ o.houseNum+'"><img src="static/images/can.png" alt="" /></a></td></tr> ';	
							}else{
								s += '</td></tr> ';
							}
		...
		<div class="house-resource">
			...
			<div class="house-search">
				<form id="myForm" action="">
					...
					<select name="houseStatus" id="houseStatus"><!--0：下架；1：上架；2：删除；3：撤销   -->
						<option value="">房源状态</option>
						<option value="0">销控</option>
						<option value="1">在售</option>
						<!-- <option value="2">删除</option> 0:销控,1:在售,2:删除,3:撤销,4:认购待审核5:待付款,6付款待确认,7:待签约,8已签约-->
			...
			<div class="house-list">
				<table cellpadding="8" cellspacing="0" id="housesInfo">
					<div id="logding" style="display: none">
						加载中...
					</div>
				</table>
			</div>
