...
function setProjectMenu2(data){
	...
	<body>
		<div class="layui-form-item" style="position: absolute;margin-left: 10px;margin-top: 10px;">
			<fieldset class="layui-elem-field site-demo-button">
				<div>
					<button class="layui-btn add-tag">导入</button>
				</div>
			</fieldset>
		</div>
	<div class="listTotal"
		style="width: 600px;height:700px;position: absolute; margin: auto; top: 100px; left: 0; right: 0; z-index: 100; display: none; background: #fff;">
