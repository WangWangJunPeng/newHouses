...
<script type="text/javascript" >
	...
	function submitForm(){
		if($("#proMenu").val()==null || $("#proMenu").val()==""){
			alert("请选先选择案场");
		}else if($("#txtFile0").val()==null || $("#txtFile0").val()==""){
			alert("请选择导入顾问文件");
		}else if($("#txtFile1").val()==null || $("#txtFile1").val()==""){
			alert("请选择导入门店中介文件");
		}else if($("#txtFile2").val()==null || $("#txtFile2").val()==""){
			alert("请选择导入带看记录文件");
		}else if($("#txtFile3").val()==null || $("#txtFile3").val()==""){
			alert("请选择导入到访记录文件");
...
<body>
	...
	<div class="mainDiv">
		...
		<div class="goOtherPage"><a href="one_file_importData_page">去导入单个文件</a></div>
	</div>
<!-- 弹框提示 -->
