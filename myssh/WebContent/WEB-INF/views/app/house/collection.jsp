...
<body class="mui-ios mui-ios-9 mui-ios-9-1">
	<header class="mui-bar mui-bar-nav mui-bar-transparent">
		<a class="ction-back mui-icon mui-icon-left-nav mui-pull-left" href="to_goToMessageApp"></a>
		<h1 class="mui-title">项目收藏夹</h1>
	...
	<div class="mui-content">
	    ...
	    <div class="referring">
	    	<form id="main" action="addGuideRecords" onsubmit="return getChecked()" method="post">
	    		...
	    		<input type="text" placeholder="联系电话"  id="phone" name="phone" title="请输入正确的手机格式"/>
	    		<input type="hidden" id="allProjectId" name="allProjectId" value=""/>
	    		<button id="btn-conf" type="submit" disabled="disabled">提交备案</button>
	    	</form>
