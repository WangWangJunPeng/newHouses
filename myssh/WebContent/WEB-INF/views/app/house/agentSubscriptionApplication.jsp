		...
		$(document).ready(function(){
			...
			function beforewancheng(){
				mui('body').on('dragstart','.mui-content',function(){
					if($('#othersbuy').is(':checked')) {
						if($("#customerId").val()!=""&&$("#realEnterBuyManInfo").val()!=""&&$("#rengourenIdCard").val()!=""&&$("#buyPrice").val()!==""&&$("#dposit").val()!==""&&$('#accountStyle').val()!=""&&$("#isAlreadyRead").is(':checked')==true&&$("#rengourenIdCard").val().length=="18"){
