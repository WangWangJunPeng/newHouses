...
<header class="mui-bar mui-bar-nav mui-bar-transparent">
        ...
        <h1 class="mui-title">${data.houseNo }(ID:${data.houseNum })</h1>
</header>
<div class="mui-content">
    ...
    <div class="banner">
        <div id="slider" class="mui-slider">
                <div class="mui-slider-group mui-slider-loop" style="transform: translate3d(-10rem, 0rem, 0rem) translateZ(0rem);transition-duration: 0.2s">
                    ...
                    <!-- <div class="mui-slider-item mui-slider-item-duplicate">
                        <a href="#">
                            <img src="static/images/bannerbig2APP.png">
                    ...
                    <c:if test="${fn:length(data.photo)<=0}">
                    	<div class="mui-slider-item mui-slider-item-duplicate">
	                        <a href="#">
	                            <img src="<%=request.getContextPath()%>/static/images/morentupian.png">
	                        </a>
	                    </div>
	                    <div class="mui-slider-item">
	                        <a href="#">
        ...
        <p class="houseName">${data.projectName }--${data.houseNo }</p>
    </div>
