...
function setTodayShopList(data,num){
	if(num==0){
		...
		if(data.length>0){
			...
			$("#t_enterBuy").html("<br/><span style='width:7%;height:30px;display:block;margin:0 auto;    border: 0px;'>暂无数据</span>");
		}
	}else if(num==1){
		...
		if(data.length>0){
			...
			$("#t_record").html("<br/><span style='width:7%;height:30px;display:block;margin:0 auto;    border: 0px;'>暂无数据</span>");
		}
	}else if(num==2){
		...
		if(data.length>0){
			...
			$("#t_guid").html("<br/><span style='width:10%;height:30px;display:block;margin:0 auto;    border: 0px;'>暂无数据</span>");
		}
	}else if(num==3){
		...
		if(data.length>0){
			...
			$("#t_willexpire").html("<br/><span style='width:10%;height:30px;display:block;margin:0 auto;    border: 0px;'>暂无数据</span>");
		}
	}
}
