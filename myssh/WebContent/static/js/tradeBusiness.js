...
function setWaitCheckList(data){
	//console.log("待审核的申请");
	var s = "<tr><th>房号</th><th>房型</th><th>建筑面积</th><th>使用面积</th><th>列表价</th><th>底价</th><th>中介供货价</th><th>申请数量</th><th>操作</th></tr>";
...
function setNotEnterGetBargainList(data) {
	...
	$.each(data, function(v, o) {
		...
		s += '<td>'+o.applyMan+'</td>';
		s += '<td>'+o.applyTime+'</td>';
		s += '<td style="text-align:center;"><a href="javascript:;" class="cert-pic" onclick=showPayMoneyVoucher("'+o.credentialsPhoto+'")>查看汇款凭证</a>';
