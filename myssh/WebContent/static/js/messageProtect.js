...
function addPics(arry){
    ...
    for(var i = 0; i< arry.length;i++){
		...
		s+="<div class='biger' data-index="+i+" style='background:url(" + loadImg + ") no-repeat center;background-size:cover;' data-id="+fid+" onmouseover='showd(this)' onmouseleave='hided()'>" +
