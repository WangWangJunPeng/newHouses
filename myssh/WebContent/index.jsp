        ...
        <div id="dowebok"> 
                        ...
                        <img alt="" src="http://root-1252955170.cossh.myqcloud.com/static/images/scoll-1/banner2.jpg" style="width:100%;height:95%;position:absolute;">
                         <div class="banner-word">
                            ...
                            <div class="reg-login">
                                ...
                                <a href="###" style="margin-left:15px;margin-right:15px;" class="every-lg" onclick="proReg()">开发商申请</a>
                    ...
                    <div class="swiper-slide" >
                        ...
                        <div class="banner-word ">
                            ...
                            <div class="reg-login">
                                ...
                                <a href="###" style="margin-left:15px;margin-right:15px;" class="every-lo" onclick="proReg()">开发商申请</a>
                         ...
                         <div class="banner-word">
                            ...
                            <div class="reg-login">
                              <a href="###" style="margin-right:15px;background-color: #ff6161;border:1px solid #ff6161;" class="every-ld" onclick="lyq()">登录</a>
                                 <a href="###" style="margin-left:15px;margin-right:15px;" class="every-ld" onclick="proReg()">开发商申请</a>
                        ...
                        <div class="banner-word">
                            ...
                            <div class="reg-login">
                               <a href="###" style="margin-right:15px;background-color: #ff6161;border:1px solid #ff6161;" class="every-lk" onclick="lyq()">登录</a>
                                 <a href="###" style="margin-left:15px;margin-right:15px;" class="every-lk" onclick="proReg()">开发商申请</a>
            ...
            <div class="section">
                <div class="banner-about">
                    ...
                    <div class="about-word">
                        <img src="http://root-1252955170.cossh.myqcloud.com/static/images/lineLeft.png" alt="" class="xxx"/>
                        <span class="fontSize">关于我们</span>
                        <img src="http://root-1252955170.cossh.myqcloud.com/static/images/lineRight.png" alt="" class="xxx"/>
                    </div>
                    ...
                    <div class="auto-play">
                        ...
                        <div class="right-auto" > 
                        	<div style="margin-top:100px;float:left;text-align:center;">
                        		<p style="font-size:18px;color:#333333;font-weight:bold;">下载苹果版</p>                   	
	                           <div class="erwei" style="float:left;margin-top:30px;">
	                           		 <img src="static/images/ios.png" alt="" />
	                           		 <p style="font-size:14px;color:#666666;margin-top:10px;">九邑Sales</p>
	                           </div> 
	                           <div class="erwei" style="float:left;margin-left:20px;margin-top:30px;">
	                           		 <img src="static/images/ios2.png" alt="" />
	                           		 <p style="font-size:14px;color:#666666;margin-top:10px;">九邑案场经理</p>
	                           </div>
	                         </div>
	                         <div style="margin-top:100px;float:left;">
	                         	   <p style="font-size:18px;color:#333333;margin-left:60px;font-weight:bold;">下载安卓版</p>                         
		                           <div class="erwei" style="float:left;margin-left:60px;margin-top:30px;">
		                           		 <img src="static/images/andriod.png" alt="" />
		                           		 <p style="font-size:14px;color:#666666;margin-top:10px;">九邑Sales</p>
		                           </div>
		                           <div class="erwei" style="float:left;margin-left:20px;margin-top:30px;">
		                           		 <img src="static/images/android2.png" alt="" />
		                           		 <p style="font-size:14px;color:#666666;margin-top:10px;">九邑案场经理</p>
		                           </div>  
		                     </div>                        
                            <div class="read-more">
            ...
            <div class="section">
                <div class="master">
                    ...
                    <div class="master-word">
                        <img src="http://root-1252955170.cossh.myqcloud.com/static/images/lineLeft.png" alt="" class="xxx"/>
                        <span class="fontSize">九邑案场大师</span>
                        <img src="http://root-1252955170.cossh.myqcloud.com/static/images/lineRight.png" alt="" class="xxx"/>
                    </div>
                     <p>新一代智慧式案场管理系统</p>
                     <div class="many">
            ...
            <div class="section" style="background:url(http://root-1252955170.cossh.myqcloud.com/static/images/scoll-4/linedec.png)center no-repeat">
                <div class="new-house">
                    ...
                    <div class="new-word">
                        <img src="http://root-1252955170.cossh.myqcloud.com/static/images/lineLeft.png" alt="" class="xxx"/>
                        <span class="fontSize">九邑Sales</span>
                        <img src="http://root-1252955170.cossh.myqcloud.com/static/images/lineRight.png" alt="" class="xxx"/>
                    </div>
